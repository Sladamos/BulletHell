...
{
public:
	Bullet(const std::string& objectName, const MathPoint& position, int damageDealt, double horizontalSpeed, double verticalSpeed);
	Bullet(const std::string& objectName, const MathPoint& position, double horizontalSpeed, double verticalSpeed);
